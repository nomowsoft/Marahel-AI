...
const Service1 = ({ onComplete }: { onComplete: () => void }) => {
    ...
    return (
        <section>
            <h1 className="text-primary text-xl md:text-2xl lg:text-4xl xl:text-5xl font-extrabold mt-10 text-center" data-aos="fade-up">
                {t('title')}
            </h1>
            <div className="lg:py-16 px-4 sm:px-6 lg:px-8 lg:max-w-screen-xl lg:mx-auto">
                <h1 className="text-xl lg:text-2xl xl:text-3xl font-extrabold mb-10" data-aos="fade-up">
                    1. {t('title0')}
                </h1>
