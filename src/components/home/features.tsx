    ...
    return (
        <section className="py-20">
            ...
            <div className="flex flex-wrap justify-center gap-6 mx-5 lg:mx-10 mt-10" data-aos="fade-up">
                {values?.map((item) => (
                    <div className="hover:bg-gradient-to-b hover:text-primary from-blue-100 to-white bg-white shadow-xl rounded-2xl py-4 px-4 w-full md:w-1/3 lg:w-1/4 flex flex-col" key={item.id}>
